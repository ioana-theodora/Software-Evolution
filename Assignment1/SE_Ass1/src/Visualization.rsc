...
public void visualizeResults(){//str vol, str complexity, str unitSize, str dupl){
	...
	row6 = [box(text("Volume")), box(text("24050")), box(text("-")), box(text("++"))];
	row7 = [box(text("Complexity per unit")), box(text("-")), box(text("-")), box(text("++"))];
	row8 = [box(text("Unit Size")), box(text("-")), box(text("-")), box(text("++"))];
	row9 = [box(text("Duplication")), box(text("-")), box(text("1515")), box(text("o"))];
	row10 = [];
	...
	row12 = [box(text("Analysability")), box(text("++")), box(text("")), box(text("++")), 
	box(text("o")), box(text("+"))];
	row13 = [box(text("Changeability")), box(text("")), box(text("++")), box(text("++")), 
	box(text("")), box(text("+"))];
	row14 = [box(text("Testability")), box(text("")), box(text("++")), box(text("++")), 
	box(text("")), box(text("++"))];
	row15 = [];
	...
	row17 = [box(text("Maintainability")), box(text("+")), box(text("+")), box(text("++")), 
	box(text("+"))];
